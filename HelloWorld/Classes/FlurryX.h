...
public:
    ...
    static void logEvent(const char* eventName, const std::map<std::string, std::string>& parameters);
    ...
    static void logEvent(const char* eventName, const std::map<std::string, std::string>& parameters, bool timed);
	static void endTimedEvent(const char* eventName);
    static void endTimedEvent(const char* eventName, const std::map<std::string, std::string>& parameters);	// non-nil parameters will update the parameters
